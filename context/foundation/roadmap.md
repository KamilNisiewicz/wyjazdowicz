...
| S-05  | `stats-dashboard`         | zobaczyć panel statystyk (bilans, %, passa, wskaźnik "pechowy kibic")        | S-03                | FR-008, FR-009, FR-010, FR-011, US-01 | zrobione |
...
- **S-05: zobaczyć panel statystyk (bilans, %, passa, wskaźnik "pechowy kibic")** — Zarchiwizowano 2026-07-26 → `context/archive/2026-07-26-stats-dashboard/`. Lekcja: —.
