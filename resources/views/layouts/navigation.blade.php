    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-base-content/50 hover:text-base-content/70 hover:bg-base-200 focus:outline-none focus:bg-base-200 focus:text-base-content/70 transition duration-150 ease-in-out">
